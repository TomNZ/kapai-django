...
class Migration(SchemaMigration):
    ...
    def forwards(self, orm):
        ...
        # Adding field 'Character.gp'
        db.add_column('raidtool_character', 'gp', self.gf('django.db.models.fields.IntegerField')(null=True, blank=True), keep_default=False)

        # Adding field 'Character.ep'
        db.add_column('raidtool_character', 'ep', self.gf('django.db.models.fields.IntegerField')(null=True, blank=True), keep_default=False)
    
    
    def backwards(self, orm):
        
        # Deleting field 'Character.gp'
        db.delete_column('raidtool_character', 'gp')

        # Deleting field 'Character.ep'
        db.delete_column('raidtool_character', 'ep')
