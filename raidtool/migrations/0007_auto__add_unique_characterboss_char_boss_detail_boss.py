...
class Migration(SchemaMigration):
    ...
    def forwards(self, orm):
        ...
        # Adding unique constraint on 'CharacterBoss', fields ['char', 'boss_detail', 'boss']
        db.create_unique('raidtool_characterboss', ['char_id', 'boss_detail_id', 'boss_id'])
    
    
    def backwards(self, orm):
        
        # Removing unique constraint on 'CharacterBoss', fields ['char', 'boss_detail', 'boss']
        db.delete_unique('raidtool_characterboss', ['char_id', 'boss_detail_id', 'boss_id'])
    ...
    models = {
        ...
        'raidtool.character': {
            ...
            'rank': ('django.db.models.fields.CharField', [], {'max_length': '1'}),
