...
class Migration(SchemaMigration):
    ...
    def forwards(self, orm):
        ...
        # Adding model 'RaidChar'
        db.create_table('raidtool_raidchar', (
        ...
        db.send_create_signal('raidtool', ['RaidChar'])
        ...
        db.create_table('raidtool_raid', (
            ...
            ('raid_date', self.gf('django.db.models.fields.DateField')(default=datetime.datetime(2010, 7, 1, 18, 54, 6, 713000))),
    ...
    def backwards(self, orm):
        ...
        # Deleting model 'RaidChar'
        db.delete_table('raidtool_raidchar')
    ...
    models = {
        ...
        'raidtool.raid': {
            ...
            'raid_date': ('django.db.models.fields.DateField', [], {'default': 'datetime.datetime(2010, 7, 1, 18, 54, 6, 756000)'}),
