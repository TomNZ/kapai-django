...
class Migration(SchemaMigration):
    ...
    def backwards(self, orm):
        ...
        # Changing field 'CharacterBoss.boss_detail'
        db.alter_column('raidtool_characterboss', 'boss_detail_id', self.gf('django.db.models.fields.related.ForeignKey')(to=orm['progression.BossDetail']))
    ...
    models = {
        ...
        'raidtool.characterboss': {
            ...
            'boss': ('django.db.models.fields.related.ForeignKey', [], {'to': "orm['progression.Boss']"}),
            'boss_detail': ('django.db.models.fields.related.ForeignKey', [], {'to': "orm['progression.BossDetail']", 'null': 'True'}),
