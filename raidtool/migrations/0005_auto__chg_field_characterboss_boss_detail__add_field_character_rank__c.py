...
class Migration(SchemaMigration):
    ...
    def forwards(self, orm):
        ...
        # Changing field 'CharacterBoss.boss_detail'
        db.alter_column('raidtool_characterboss', 'boss_detail_id', self.gf('django.db.models.fields.related.ForeignKey')(to=orm['progression.BossDetail'], null=True, blank=True))

        # Adding field 'Character.rank'
        db.add_column('raidtool_character', 'rank', self.gf('django.db.models.fields.CharField')(max_length=1, null=True, blank=True), keep_default=False)

        # Changing field 'Character.user'
        db.alter_column('raidtool_character', 'user_id', self.gf('django.db.models.fields.related.ForeignKey')(to=orm['auth.User'], null=True, blank=True))
    
    
    def backwards(self, orm):
        
        # Changing field 'CharacterBoss.boss_detail'
        db.alter_column('raidtool_characterboss', 'boss_detail_id', self.gf('django.db.models.fields.related.ForeignKey')(to=orm['progression.BossDetail'], null=True))

        # Deleting field 'Character.rank'
        db.delete_column('raidtool_character', 'rank')

        # Changing field 'Character.user'
        db.alter_column('raidtool_character', 'user_id', self.gf('django.db.models.fields.related.ForeignKey')(to=orm['auth.User'], null=True))
