...
class Migration(SchemaMigration):
    ...
    def forwards(self, orm):
        ...
        # Adding model 'Raid'
        db.create_table('raidtool_raid', (
            ('last_boss_detail', self.gf('django.db.models.fields.related.ForeignKey')(to=orm['progression.BossDetail'], null=True, blank=True)),
            ('last_instance', self.gf('django.db.models.fields.related.ForeignKey')(to=orm['progression.Instance'], null=True, blank=True)),
            ('raid_date', self.gf('django.db.models.fields.DateField')(default=datetime.datetime(2010, 7, 1, 18, 42, 22, 642000))),
            ('last_boss', self.gf('django.db.models.fields.related.ForeignKey')(to=orm['progression.Boss'], null=True, blank=True)),
            ('id', self.gf('django.db.models.fields.AutoField')(primary_key=True)),
            ('user', self.gf('django.db.models.fields.related.ForeignKey')(to=orm['auth.User'])),
        ))
        db.send_create_signal('raidtool', ['Raid'])

        # Adding model 'RaidCharacter'
        db.create_table('raidtool_raidcharacter', (
            ...
            ('raid', self.gf('django.db.models.fields.related.ForeignKey')(to=orm['raidtool.Raid'])),
            ('id', self.gf('django.db.models.fields.AutoField')(primary_key=True)),
        ))
        db.send_create_signal('raidtool', ['RaidCharacter'])
    
    
    def backwards(self, orm):
        
        # Deleting model 'Raid'
        db.delete_table('raidtool_raid')

        # Deleting model 'RaidCharacter'
        db.delete_table('raidtool_raidcharacter')
    ...
    models = {
        ...
        'raidtool.raid': {
            ...
            'raid_date': ('django.db.models.fields.DateField', [], {'default': 'datetime.datetime(2010, 7, 1, 18, 42, 22, 680000)'}),
            'user': ('django.db.models.fields.related.ForeignKey', [], {'to': "orm['auth.User']"})
        },
        'raidtool.raidcharacter': {
            'Meta': {'object_name': 'RaidCharacter'},
            'char': ('django.db.models.fields.related.ForeignKey', [], {'to': "orm['raidtool.Character']"}),
            'id': ('django.db.models.fields.AutoField', [], {'primary_key': 'True'}),
