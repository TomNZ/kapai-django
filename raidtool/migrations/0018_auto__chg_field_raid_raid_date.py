...
class Migration(SchemaMigration):
    ...
    def forwards(self, orm):
        ...
        db.alter_column('raidtool_raid', 'raid_date', self.gf('django.db.models.fields.DateTimeField')(null=True, blank=True))
    ...
    models = {
        ...
        'raidtool.raid': {
            ...
            'raid_date': ('django.db.models.fields.DateTimeField', [], {'null': 'True', 'blank': 'True'}),
