...
class Migration(SchemaMigration):
    ...
    def forwards(self, orm):
        ...
        db.create_unique('raidtool_character', ['name'])

        # Changing field 'Character.rank'
        db.alter_column('raidtool_character', 'rank', self.gf('django.db.models.fields.CharField')(max_length=1, null=True, blank=True))

        # Changing field 'Character.main_role'
        db.alter_column('raidtool_character', 'main_role_id', self.gf('django.db.models.fields.related.ForeignKey')(to=orm['raidtool.CharacterRole'], null=True, blank=True))

        # Changing field 'Character.char_class'
        db.alter_column('raidtool_character', 'char_class_id', self.gf('django.db.models.fields.related.ForeignKey')(to=orm['recruitment.RecruitmentClass'], null=True, blank=True))
    
    
    def backwards(self, orm):
        
        # Removing unique constraint on 'Character', fields ['name']
        db.delete_unique('raidtool_character', ['name'])

        # Changing field 'Character.rank'
        db.alter_column('raidtool_character', 'rank', self.gf('django.db.models.fields.CharField')(max_length=1))

        # Changing field 'Character.main_role'
        db.alter_column('raidtool_character', 'main_role_id', self.gf('django.db.models.fields.related.ForeignKey')(to=orm['raidtool.CharacterRole']))

        # Changing field 'Character.char_class'
        db.alter_column('raidtool_character', 'char_class_id', self.gf('django.db.models.fields.related.ForeignKey')(to=orm['recruitment.RecruitmentClass']))
