...
class Migration(SchemaMigration):
    ...
    def forwards(self, orm):
        ...
        # Adding field 'CharacterBoss.reason'
        db.add_column('raidtool_characterboss', 'reason', self.gf('django.db.models.fields.CharField')(max_length=1, null=True, blank=True), keep_default=False)

        # Adding field 'CharacterBoss.notes'
        db.add_column('raidtool_characterboss', 'notes', self.gf('django.db.models.fields.CharField')(max_length=100, null=True, blank=True), keep_default=False)


    def backwards(self, orm):
        
        # Deleting field 'CharacterBoss.reason'
        db.delete_column('raidtool_characterboss', 'reason')

        # Deleting field 'CharacterBoss.notes'
        db.delete_column('raidtool_characterboss', 'notes')
